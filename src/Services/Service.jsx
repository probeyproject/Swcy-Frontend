...
function Service() {
  ...
  return (
    <>
    {/* <!-- Facts Start --> */}
    <div className="conta88 iner-fluid facts my-2 py-2">
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
              ...
              <Link className="btn text-white py-3 px-5" style={{background:"darkblue"}} to="/shop">
                Shop Now
              </Link>
            </div>
                  ...
                  <div className="row g-4">
                    ...
                    <div className="col-12 wow fadeIn" data-wow-delay="0.5s">
                      ...
                      <FaCheck className="d_color fs-2" />
                        ...
                        <Link className="fw-semi-bold d_color decoration-none" to="/shop/Female">
                          Shop Now <IoIosArrowDroprightCircle />
                ...
                <div className="tab-pane fade show active" id="tab-pane-1">
                  <div className="row g-4">
                    ...
                    <div className="col-md-6">
                      ...
                      <p>
                        < FaCheck className='d_color'/> Secured
                        Loans
                      </p>
                      <p>
                        < FaCheck className='d_color'/> Credit
                        Facilities
                      </p>
                      <p>
                        < FaCheck className='d_color'/> Cash
                        Advanced
                      </p>
                      <Link
                        to="/shop"
                        className="btn text-white py-3 px-5 mt-3" style={{background:'darkblue'}}
                      >
                        Shop Now
                      </Link>
                    </div>
